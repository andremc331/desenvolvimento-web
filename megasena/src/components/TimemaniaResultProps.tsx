...
import { TimemaniaResultProps } from "../types";

const TimemaniaResult: React.FC<TimemaniaResultProps> = ({ timemania }) => {
  return (
    <Panel>
      <h1>Último Sorteio da Timemania</h1>
...
export default TimemaniaResult;
